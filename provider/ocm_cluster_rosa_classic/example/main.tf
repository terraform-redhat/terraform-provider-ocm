...
module sts_roles {
    source  = "openshift-online//rosa-sts-roles/aws"
    create_account_roles = false
    clusters = [{
        id = ocm_cluster_rosa_classic.rosa_sts_cluster.id
        operator_role_prefix = var.operator_role_prefix
    }]
    rh_oidc_provider_thumbprint = ocm_cluster_rosa_classic.rosa_sts_cluster.thumbprint
